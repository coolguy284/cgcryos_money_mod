    ...
    public CCMMBankCommand(CommandDispatcher<CommandSource> dispatcher) {
        dispatcher.register(
                Commands.literal("ccmm").then(Commands.literal("bank")
                        ...
                        .then(Commands.literal("zop").requires(Libs::OPRequirement)
                                .then(Commands.literal("list").then(Commands.argument("player", GameProfileArgument.gameProfile()).executes(this::CCMMBankListOtherAccounts)))
                                .then(Commands.literal("get").then(Commands.argument("player", GameProfileArgument.gameProfile()).then(Commands.argument("account", StringArgumentType.string()).executes(this::CCMMBankGetOtherAccount))))
                                .then(Commands.literal("create").then(Commands.argument("player", GameProfileArgument.gameProfile()).then(Commands.argument("account", StringArgumentType.string()).executes(this::CCMMBankCreateOtherAccount))))
                                .then(Commands.literal("remove").then(Commands.argument("player", GameProfileArgument.gameProfile()).then(Commands.argument("account", StringArgumentType.string()).executes(this::CCMMBankRemoveOtherAccount).then(Commands.argument("transfer_account", StringArgumentType.string()).executes(this::CCMMBankRemoveOtherAccount)))))
                                .then(Commands.literal("transfer")
                                ...
                                .then(Commands.literal("add").then(Commands.argument("player", GameProfileArgument.gameProfile()).then(Commands.argument("account", StringArgumentType.string()).then(Commands.argument("amount", MoneyArgumentType.moneyArg()).executes(this::CCMMBankAddToOtherAccount)))))
                                .then(Commands.literal("set").then(Commands.argument("player", GameProfileArgument.gameProfile()).then(Commands.argument("account", StringArgumentType.string()).then(Commands.argument("amount", MoneyArgumentType.moneyArg()).executes(this::CCMMBankSetOtherAccount)))))
                                .then(Commands.literal("default")
